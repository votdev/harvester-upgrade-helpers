...
run_validator_daemonset()
{
    ...
    local bci_base_image=$(crictl images 2>/dev/null | awk '/registry\.suse\.com\/bci\/bci-base/ { print $1 ":" $2 }' | grep -v none | tail -n 1)
    ...
    # This ensures every line of the script is indented by at least 10 space
